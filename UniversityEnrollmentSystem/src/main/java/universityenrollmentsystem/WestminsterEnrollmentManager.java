...
public class WestminsterEnrollmentManager implements EnrollmentManager{
    ...
    public void printPersonList() {
        ...
        System.out.println("Enter 2 to sort by surname :");
        int order = input.nextInt();

//====================================================================================================================================================================
        switch(order){
            case 1:
                Collections.sort(personList, new Person.NameCompare());
                break;
            case 2:
                Collections.sort(personList, new Person.SurnameCompare());
                break;
        }
//====================================================================================================================================================================
...
//========================================================================================================================================================================
                        Student s = (Student)personList.get(i);
//========================================================================================================================================================================
                        ...
                        personList.get(i).setDob(dob);

//==========================================================================================================================================================================
                        System.out.println("Enter course name :");
                        String Cname = input.nextLine();
                        ((Student)personList.get(i)).setCourseTitle(Cname);

                        System.out.println("Enter course no of modules :");
                        int Nmodules = input.nextInt();
                        s.setModulesEnrolled(Nmodules);

//==========================================================================================================================================================================

                    }
                    if(personList.get(i) instanceof Lecturer){
                        System.out.println("Lecturer");

                        Lecturer L = (Lecturer) personList.get(i);
                    ...
                    if(personList.get(i) instanceof SupportStaff){
